    ...
    <div className="space-y-8 md:p-6 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-orange-500 text-white rounded-full p-3 sm:rounded-lg sm:px-4 sm:py-2 flex items-center sm:space-x-2 transition-colors hover:bg-orange-600 fixed bottom-6 right-6 sm:static shadow-lg sm:shadow-none z-30 sm:z-auto"
        >
