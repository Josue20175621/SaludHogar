    ...
    <div className="space-y-8 md:p-6 bg-gray-50 min-h-screen">
      ...
      <div className="group fixed bottom-6 right-6 z-30">
        <button
          ...
          className="bg-orange-500 text-white rounded-full p-3 flex items-center justify-center transition-all duration-300 hover:bg-orange-600 shadow-lg hover:shadow-xl hover:scale-110"
